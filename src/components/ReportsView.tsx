...
export const ReportsView: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl border border-slate-200 shadow-2xs print:border-none print:shadow-none print:p-0">
        {/* Print Header */}
        ...
        <div className="mt-12 pt-8 border-t border-slate-300 grid grid-cols-2 gap-8 text-xs text-slate-500">
